    ...
    <div class="container">
        <div class="row align-items-center mb-4">
            ...
            <div class="col-md-8 choose_us_title">
                <h2 class="mb-0">Recognised Security Organisations</h2>
            </div>
            <!-- Right Title -->
        ...
        <div class="row choose_us">
            ...
            <div class="col-md-12 py-3">
                <div class="row">
                    <div class="col-md-12">
                        <div class="intro">
                            <h5>Altec Services S.r.l.</h5>
                            <p>
                                <strong>Address:</strong>
                                 Genoa – Via Bombrini 13/5 Italy
                                 <br>
                            ...
                            <ul>
                                <li>Ship Security Plan approval</li>
                                <li>Verification for ships</li>
                                <li>Endorsement of Ship Security Certificates</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="popular-services position-relative">
            ...
            <div class="content_hover position-absolute">
                    <a href=""> <span class="ms-5 mb-1 hover-icon-position"><i class="fa-solid fa-arrow-right"></i></a>
                <a href="">
                    <h3 class="text-white fs-4">Merchant Ships</h3>
                </a>
                <p class="text-p">
