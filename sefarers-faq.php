        ...
        <div class="row choose_us">
            <div class="col-md-12 col-lg-8  ">
                ...
                <div class=" choose_us_title">
                    <h2 class="mb-5">Seafarers FAQ's</h2>
                </div>
                <div class="row px-3 py-5 bg_color">
                    <div class="col-md-12 py-3">
                        <div class="row">
                            <div class="col-md-12">
                                <p>
                                    Please find a list of Seafarer frequently asked questions. If you do not find what you are looking for here please contact our Seafarer Training & Certification Department here.</p>

                                <?php include './components/seafarersfaq.php'; ?>
