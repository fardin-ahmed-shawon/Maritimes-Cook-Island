                ...
                <div class="row choose_us">
                    <div class="col-md-12 col-lg-8 ">
                        ...
                        <div class="choose_us_title">
                            <h2 class="mb-5">Training & Certification</h2>
                        </div>
                        <div class="row p-2 bg_color">
                            <div class="col-md-12 py-3">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h3>The International Convention on Standards of Training, Certification and Watchkeeping for Seafarers (STCW) 1978, as amended.</h3>
                                        <p>The Cook Islands are party to the International Convention on Standards of Training, Certification and Watchkeeping for Seafarers (STCW) 1978, as amended.</p>
                                        ...
                                        <p>The STCW requires deck and engineer officers and radio operators as defined in Regulation I/1 of the STCW Convention, as amended, to possess STCW or STCW equivalent (Non-STCW) documentation. This includes officers and seafarers fulfilling capacities indicated on the Minimum Safe Manning Certificate (MSMC) issued for the vessel.</p>

                                        <p>Seafarers intending to serve in Officer capacities aboard Cook Islands vessels to which the STCW applies, are required to apply for Flag Endorsement prior to embarkation.</p>
                                    </div>
