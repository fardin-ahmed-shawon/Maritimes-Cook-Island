                ...
                <div class="row choose_us">
                    <div class="col-md-12 col-lg-8 ">
                        ...
                        <div class="choose_us_title">
                            <h2 class="mb-5">Wrecks Insurance</h2>
                        </div>
                        <div class="row p-2 bg_color">
                            <div class="col-md-12 py-3">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h3>Nairobi International Convention on removal of Wrecks, 2007</h3>
                                    <p>The Cook Islands has acceded to the Nairobi International Convention on the Removal of Wrecks, 2007 which will enter into force on the 14th April 2015.</p>
                                   <p>Registered owners of ships above 300GT will need insurance cover arrangements, which meet the requirements of the Convention. The Convention provides a strict liability, compensation and compulsory insurance regime for States affected by a maritime casualty. It makes the registered owner of a ship liable for locating, marking and removing a wreck deemed to be a hazard in a State’s Convention area.</p>
                                   <p>The Convention provides that for compulsory insurance purposes liability under Certificates shall not exceed the limits calculated in accordance with the Convention on Limitation of Liability for Maritime Claims 1976 (LLMC 1976), as amended by the 1996 Protocol. A Blue Card issued by a recognized P&I Insurer, which can be verified, will be evidence of insurance cover being in place and will be used as the basis for the issuance of the Nairobi Convention Certificate</p>
                                   <p>Vessels will need a certificate from a State party attesting insurance is in force. Certificates must be carried on board at all times.</p>
                                   <p>Vessels registered in a State, which is not party to the Convention, but which perform voyages to countries that are Parties should obtain a certificate from a State Party. Cook Islands is a State Party and is prepared to issue certificates to owners of vessels registered in States who are not party to the Nairobi Convention.</p>
                                   <h4>Wrecks Online Application Process</h4>
                                   <strong>Step 1: Apply online</strong>
                                   ...
                                   <p>Part of the online application requests for the blue card to be uploaded. You can obtain the blue card from your <a href="insurance-pi-insurers.php"> P&I club</a>and upload it in the application.</p>
                                  <strong>Step 3: Make your payment and attach it to the application. </strong>
                                  <p>The NWRC Certificate costs USD$300 per certificate.</p>
                                  ...
                                  <p>For more information on our list of <a href="insurance-pi-insurers.php"> Approved P&I Insurers</a>, please click here.</p>
...
<p>If a certificate is however cancelled due to change of name of vessel or owner etc, please apply as a new application and follow the instructions in “How to Apply”.</p>
                                </div>
