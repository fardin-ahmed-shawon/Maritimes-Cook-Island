    ...
    <div class="container">
        ...
        <div class="row choose_us">
            ...
            <div class=" choose_us_title">
                <h2 class="mb-5">Minimum Safe Manning Guidelines</h2>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="intro">
                                    ...
                                    <p class="text-p">Prior to registration, an owner must submit their minimum safe manning proposal for approval by MCI Technical Department.</p>
                                    <p class="text-p">The manning levels for commercial yachts are defined in the Cook Islands Large Yacht Code , and in the Cook Islands Small Yacht Code; MSM guidance tables for all the other types of vessels can be provided by MCI upon request.</p>
                                    <p class="text-p">Every Cook Islands flagged vessel that is required to carry a Minimum Safe Manning Certificate must have onboard the prescribed complement of officers and qualified ratings as specified therein. The vessel’s manning is verified for compliance with the Minimum Safe Manning Certificate during the vessel’s annual inspection</p>
                                    <h6>Seafarer Nationality</h6>
                                    <p>There are no restrictions as to the nationality of seafarers employed on Cook Islands flagged vessels.</p>
                                    <div class="d-flex justify-content-between border border-top-0 border-start-0 border-end-0">
                                        ...
                                        <a href="./pdf/Form-6-Minimum-Safe-Manning-Application-v11-1.pdf">
