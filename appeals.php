...
<p>Any affected individual or organisation affected by a decision made by the Seafarer Training & Certification Department (STC) has the right to appeal.</p>
<p>Appeals against a decision made by the Seafarer Training & Certification Department</p>
<p>If you wish to appeal a decision of the STC Department, you must submit a written appeal to the Head of Seafarer Training & Certification by email at <a>seafarers@maritimecookislands.com</a>. Your appeal should include:</p>
<ul class="list-group-numbered">
   <li>Decision Details – Identify the decision or application being appealed (with reference number/date if available).</li> 
   <li>Reasons for Appeal – Provide a clear explanation of why you believe the decision or process was incorrect</li>
   <li>Supporting Evidence – Attach any documents or information that support the appeal.</li>

</ul>
<p>The Head of Department will determine the merits of the appeal and issue a written decision to all parties involved.</p>
<p>Appeal to the High Court</p>
<p>If you are not satisfied with the outcome of the internal appeal, you may apply to the High Court of the Cook Islands in accordance with the <a href="./html/Maritime-Transport-Act.html">Maritime Transport Act 2008.</a>
